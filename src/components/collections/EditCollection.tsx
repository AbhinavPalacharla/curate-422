...
//   const sampleCollectionData = { id: 1, name: "Collection 1", icon: "" };
...
//           {getIconByName({
//             name: icon ?? (sampleCollectionData?.icon as IconName | undefined),
//             nullIcon: { size: "SMALL" },
//           })}
//           <h1 className="text-sm text-[#969696] font-light">
//             {sampleCollectionData?.name}
//           </h1>
//         </div>
//       </div>
//       <div className="my-4">
...
//                   name:
//                     icon ??
//                     (sampleCollectionData?.icon as IconName | undefined),
//                   nullIcon: { size: "LARGE" },
